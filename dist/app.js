(() => {
  // node_modules/.pnpm/hyperapp@2.0.19/node_modules/hyperapp/index.js
  var SSR_NODE = 1;
  var TEXT_NODE = 3;
  var EMPTY_OBJ = {};
  var EMPTY_ARR = [];
  ...
  // src/jsx.js
  var jsx = (type, props, ...children) => typeof type === "function" ? type(props, children) : h(type, props || {}, [].concat(...children).map((any) => typeof any === "string" || typeof any === "number" ? text(any) : any));
  ...
  var Newt = (state) => /* @__PURE__ */ jsx_default("div", null, /* @__PURE__ */ jsx_default("p", null, "hello world"), /* @__PURE__ */ jsx_default(jsx_default.Fragment, null, /* @__PURE__ */ jsx_default("div", null, "nah")));
  app({
    init: initialState,
    view: Newt,
