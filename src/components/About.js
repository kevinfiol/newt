...
newt is distributed under the [GNU General Public License v3.0](https://www.gnu.org/licenses/gpl-3.0.en.html). Its source can be found on [Github](https://github.com/kevinfiol/newt).
